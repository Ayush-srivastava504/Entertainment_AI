...
// This panel holds all of the chat widget's real logic (polling, fetch,
// message state). It's only mounted once the user actually opens the chat
// (see GlobalChat.tsx, which lazy-imports this component), so this code
// no longer ships in the shared bundle that every page downloads on load.
